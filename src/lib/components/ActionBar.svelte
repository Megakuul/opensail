...
<div class="flex flex-row justify-between w-full">
  ...
  <input type="checkbox" id="dropdownCheckbox" class="invisible" bind:checked={showVersionDropdown}>
  <label for="dropdownCheckbox" class="relative m-2 py-2 px-4 flex items-center gap-1 cursor-pointer rounded-lg text-slate-300/80  bg-slate-300/15 transition-all duration-700">
    <span>
    ...
    <div transition:fade class="absolute top-full right-0 h-64 w-28 mt-2 flex flex-col rounded-xl overflow-scroll-hidden bg-slate-300/15">
