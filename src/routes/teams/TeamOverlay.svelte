...
<div class="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/70 overscroll-contain">
  <div class="relative w-full sm:w-[90%] h-[100dvh] sm:h-[90%] flex flex-col gap-10 p-4 sm:p-16 rounded-none sm:rounded-lg overflow-scroll-hidden overscroll-contain bg-slate-900/90">
